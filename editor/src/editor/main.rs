...
async fn create_device(
    ...
    let adapter = instance
            ...
            If you're running this from inside nix, follow the instructions here to resolve this:https://github.com/witoldsz/scratchpad/tree/roc-trunk/BUILDING_FROM_SOURCE.md#editor
            "#);
